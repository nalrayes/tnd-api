...
#:   with blanks translated to underratings.
#:
...
#:   case, with blanks translated to underratings.
#:
#: * Value: Normalized value.
NORMALIZED_LSB_ID = {
...
#:   translated to lower case, with blanks translated to underratings.
#:
#: * Value: Normalized value.
...
def id():
    ...
    * blanks (which should not be there anyway) are translated to underratings,
